...
namespace pocketmine\network\bedrock\adapter\v448\palette;
...
final class ItemPalette{
	...
	public static function init() : void{
		...
		$itemList = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v448/required_item_list.json"), true);
