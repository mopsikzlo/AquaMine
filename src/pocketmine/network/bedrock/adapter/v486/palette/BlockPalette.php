...
namespace pocketmine\network\bedrock\adapter\v486\palette;
...
final class BlockPalette{
	...
	public static function init() : void{
		...
		$rawData = file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v486/canonical_block_states.nbt");

		$blockStates = array_map(function(TreeRoot $root) : CompoundTag{
			return $root->mustGetCompoundTag();
		}, $nbt->readMultiple($rawData));

		$legacyIdMap = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/block_id_map.json"), true);

		/** @var R12ToCurrentBlockMapEntry[] $legacyStateMap */
		$legacyStateMap = [];
		$legacyStateMapReader = new NetworkBinaryStream(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v486/r12_to_current_block_map.bin"));
