...
namespace pocketmine\network\bedrock\adapter\v471\palette;
...
final class ItemPalette{
	...
	public static function init() : void{
		...
		$itemList = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v471/required_item_list.json"), true);
