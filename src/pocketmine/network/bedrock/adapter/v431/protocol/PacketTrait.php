...
namespace pocketmine\network\bedrock\adapter\v431\protocol;
...
use pocketmine\network\bedrock\adapter\v431\palette\BlockPalette as BlockPlatte431;
...
trait PacketTrait{
    ...
    public function putItemStack(Item $item, \Closure $writeExtraCrapInTheMiddle) : void{
        ...
        [$netId, $netData] = ItemPalette431::getRuntimeFromLegacyId($item->getId(),$item instanceof Durable ? 0 : $item->getDamage());
        ...
        if($isBlockItem){
            ...
            if($block->getId() !== BlockIds::AIR){
                $blockRuntimeId = BlockPlatte431::getRuntimeFromLegacyId($block->getId(), $block->getDamage());
            }
        }
