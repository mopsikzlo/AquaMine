...
namespace pocketmine\network\bedrock\adapter\v431\palette;
...
final class ItemPalette{
	...
	public static function init() : void{
		/** @var int[] $itemPalette */
		$itemMap = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v448/r16_to_current_item_map.json"), true);
		...
		$itemList = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v431/required_item_list.json"), true);
