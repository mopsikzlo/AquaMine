...
namespace pocketmine\network\bedrock\adapter\v475\palette;
...
final class BlockPalette{
	...
	public static function init() : void{
		...
		$rawData = file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v475/canonical_block_states.nbt");
		...
		$legacyStateMap = [];
		$legacyStateMapReader = new NetworkBinaryStream(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v475/r12_to_current_block_map.bin"));
