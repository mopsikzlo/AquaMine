...
final class ItemPalette{
	...
	public static function init() : void{
		/** @var int[] $itemPalette */
		$itemMap = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v475/r16_to_current_item_map.json"), true);
		...
		$itemList = json_decode(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v475/required_item_list.json"), true);
