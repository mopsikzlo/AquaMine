...
namespace pocketmine\network\bedrock\adapter\v503\palette;
...
final class BlockPalette{
	...
	public static function init() : void{
		...
		$rawData = file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v503/canonical_block_states.nbt");
		...
		$legacyStateMap = [];
		$legacyStateMapReader = new NetworkBinaryStream(file_get_contents(\pocketmine\PATH . "src/pocketmine/resources/bedrock/v503/r12_to_current_block_map.bin"));
