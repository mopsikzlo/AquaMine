...
interface ProtocolInfo{
    ...
    public const EDU_URI_RESOURCE_PACKET = 0xaa; // unsupported
    public const CREATE_PHOTO_PACKET = 0xab; // unsupported
    public const UPDATE_SUB_CHUNK_BLOCKS_PACKET = 0xac; // unsupported
    public const PHOTO_INFO_REQUEST_PACKET = 0xad; // unsupported
    public const SUB_CHUNK_PACKET = 0xae; // unsupported
    public const SUB_CHUNK_REQUEST_PACKET = 0xaf; // unsupported
	public const PLAYER_START_ITEM_COOLDOWN_PACKET = 0xb0; // unsupported
	public const SCRIPT_MESSAGE_PACKET = 0xb1; // unsupported
	public const CODE_BUILDER_SOURCE_PACKET = 0xb2; // unsupported
	public const TICKING_AREAS_LOAD_STATUS_PACKET = 0xb3; // unsupported
	public const DIMENSION_DATA_PACKET = 0xb4; // unsupported
