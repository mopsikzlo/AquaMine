...
class SwampGrass extends VariableAmountPopulator{
/** @var ChunkManager */
private $level;
...
if($y !== -1 and $this->canSwampGrassStay($x, $y, $z)){
 $rnd = mt_rand(0,3);
 if($rnd == 1){ 
...
$level->setBlockDataAt($x, $y+1, $z, 11);
}else{
...
private function canSwampGrassStay($x, $y, $z){
