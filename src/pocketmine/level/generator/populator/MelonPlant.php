...
class MelonPlant extends VariableAmountPopulator{
	/** @var ChunkManager */
	private $level;
	...
	public function populate(ChunkManager $level, $chunkX, $chunkZ, Random $random){
		...
		for($i = 0; $i < $amount; ++$i){
			...
			if($y !== -1 and $this->canMelonPlantStay($x, $y, $z)){
				$this->level->setBlockIdAt($x, $y, $z, 103);
				$this->level->setBlockDataAt($x, $y, $z, 0);				
			}
		}
	}

	private function canMelonPlantStay($x, $y, $z){
