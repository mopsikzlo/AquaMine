...
class RosePlant extends VariableAmountPopulator{
	/** @var ChunkManager */
	private $level;
	...
	public function populate(ChunkManager $level, $chunkX, $chunkZ, Random $random){
		...
		for($i = 0; $i < $amount; ++$i){
			...
			if($y !== -1 and $this->canRosePlantStay($x, $y, $z)){
				$this->level->setBlockIdAt($x, $y, $z, 175);
				$this->level->setBlockDataAt($x, $y, $z, 4);
	...
	private function canRosePlantStay($x, $y, $z){
